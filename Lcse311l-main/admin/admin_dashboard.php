		    ...
		    <ul class="nav navbar-nav navbar-right">
		      <li class="nav-item dropdown">
	        	...
	        	<div class="dropdown-menu">
	        		...
	        		<div class="dropdown-divider"></div>
	        		<a class="dropdown-item" href="change_password.php">Change Pass</a>
	        	</div>
		      </li>
		      <li class="nav-item">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-danger" href="Regusers.php" target="_blank">Registered Users</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-success" href="Regbooks.php" target="_blank">All Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-primary" href="Regauthor.php" target="_blank">Authors</a>
				</div>
			</div>
		</div>
	</div><br><br>
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-success" href="view_issued_book.php" target="_blank">Issued Books</a>
				</div>
			</div>
		</div>
